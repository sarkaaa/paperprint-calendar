...
export default function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between">
      <section className="bg-gradient-to-tr from-indigo-50 to-indigo-100 p-6 py-10 lg:p-24 w-full">
        <div className="max-w-screen-2xl w-auto mx-auto">
      <div className="flex justify-center">
        <HeaderIcon />
      </div>
      <h1 className={`${angkor.className} text-indigo-800 text-4xl md:text-6xl text-center mt-12 mb-3`}>
        Paperprint calendar
      </h1>
      <div className="mx-auto my-8">
        <p className={`${inter.className} font-bold text-gray-600 text-xl md:text-2xl text-center mt-8 mb-6`}>
          Design and print your custom paper calendar.
        </p>
      </div>
      <div className="relative flex justify-center gap-2 my-8">
        <a href="https://github.com/sarkaaa/paperprint-calendar" className="px-4 py-2 bg-slate-300 hover:bg-slate-400 focus:bg-slate-400 font-semibold rounded-md inline-block transition-all text-center" target="_blank">Github.com</a>
        <Link activeClass="active"
          ...
          isDynamic={true}
        >
          <span className="px-4 py-2 bg-indigo-600 hover:bg-indigo-800 focus:bg-indigo-800 rounded-md inline-block text-white font-semibold cursor-pointer transition-all text-center">Create your calendar</span>
        </Link>
      </div>
      <div>
        <div>
        ...
        <div className="flex flex-wrap flex-col md:flex-row gap-8 md:gap-12 w-2/3 mx-auto">
          {
      ...
      <section className="bg-white p-6 py-10 lg:p-24 lg:pb-8 w-full" id="canvas">
